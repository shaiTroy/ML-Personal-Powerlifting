...
optimizer = torch.optim.Adam(model.parameters(), lr=0.0003422243599208432, weight_decay=2.681934947945312e-06)
criterion = torch.nn.MSELoss()

model_save_path = "bench_model.pth"
