...
optimizer = torch.optim.Adam(model.parameters(), lr=0.007704778874601575, weight_decay=3.5476314084994914e-05)
criterion = torch.nn.MSELoss()

model_save_path = "deadlift_model.pth"
...
print(f"MSE for Deadlift: {mse:.4f}")

mae_loss = torch.nn.L1Loss()
mae = mae_loss(y_pred1, Outputs_Test.to(device))

print(f"MAE for Deadlift: {mae:.4f}")
